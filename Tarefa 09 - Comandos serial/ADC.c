...
void init_ADC(void)
{
    ...
    light_param = 60;                               // Inicializa o parâmetro de acionamento da luz
}

int return_light_value(void)
{
    return ADCMEM0;
}

void change_light_param(volatile int value) // Altera o duty cycle pelo serial
{
    light_param = value;
}
